<div class="container" style="margin-top: 15rem;">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        <p class="col-md-4 mb-0 text-muted">© 2024 Somjess Rithbunreng</p>

        <a href="?page=home" class="col-md-4 d-flex align-items-center justify-content-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none fw-bold fs-3"><?php echo WEBSITE_NAME ?></a>
