                            ...
                            foreach ($products as $index => $product) {
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <img src="../upload/product/<?php echo $product['img']; ?>" width="50"
                                            onerror="this.onerror=null; this.src='../assets/images/404.webp';">
                                    </td>
                                    <td class="align-middle">
                                        <div class="text-truncate" style="max-width: 15rem;" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="<?php echo htmlspecialchars($product['name']); ?>">
                                    ...
                                    <td class="align-middle">
                                        <div class="text-truncate" style="max-width: 30rem;" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="<?php echo htmlspecialchars($product['detail']); ?>">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination mb-0">
                        <li class="page-item <?php echo ($current_page <= 1) ? 'disabled' : ''; ?>">
                            <a class="page-link"
                                href="?page=products&p=<?php echo $current_page - 1; ?>&search=<?php echo urlencode($search); ?>&type=<?php echo urlencode($type); ?>">ก่อนหน้า</a>
                        </li>
                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                            <li class="page-item <?php echo ($current_page == $i) ? 'active' : ''; ?>">
                                <a class="page-link"
                                    href="?page=products&p=<?php echo $i; ?>&search=<?php echo urlencode($search); ?>&type=<?php echo urlencode($type); ?>"><?php echo $i; ?></a>
                            </li>
                        <?php endfor; ?>
                        <li class="page-item <?php echo ($current_page >= $total_pages) ? 'disabled' : ''; ?>">
                            <a class="page-link"
                                href="?page=products&p=<?php echo $current_page + 1; ?>&search=<?php echo urlencode($search); ?>&type=<?php echo urlencode($type); ?>">ต่อไป</a>
                        </li>
                    </ul>
                </nav>
            </div>
                ...
                <form id="addProductForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="product_name" name="product_name" maxlength="255"
                            placeholder="กรุณากรอกชื่อสินค้า" required>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="product_price" name="product_price" min="0"
                                step="1" placeholder="กรุณากรอกราคาสินค้า" required>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="modal-body">
                <form id="editProductForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="edit_product_description" name="product_description" rows="4"
                            placeholder="กรุณากรอกรายละเอียดสินค้า"></textarea>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="edit_product_price" class="form-label">ราคา (บาท)</label>
                    ...
                    <div class="mb-3">
                        <label for="edit_product_image" class="form-label">รูปภาพสินค้า <small
                                class="text-muted">(ไม่บังคับ หากไม่เปลี่ยนให้เว้นว่าง)</small></label>
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <img id="edit_product_preview" src="" alt="preview"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        window.editProduct = function (id) {
            fetch(`../core/helpers/get_data.php?type=product&id=${id}`)
                ...
                .then(product => {
                    ...
                    if (product.img) {
                        preview.src = `../upload/product/${product.img}`;
        ...
        // Reset image preview when edit modal closes
